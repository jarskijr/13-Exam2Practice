...
def run_test_practice_problem2a():
    ...
    delta = 6
    print([3, 11, 6, -19, 9], expected, delta
                                  )
    actual = practice_problem2a([3, 11, 6, -19, 9], delta)
    print(expected, actual)

    # Test 2:
    expected = [2, 13, 6]
    delta = 6
    print([-4, 7, 0], expected, delta
                                  )
    actual = practice_problem2a([-4, 7, 0], delta)
    print(expected, actual)
